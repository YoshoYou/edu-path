import {LucideGraduationCap, Medal} from 'lucide-react'
...
const Hero = () => {
  ...
  return (
    <div className="grid bg-emerald-50   sm:px-10 px-4 py-30  grid-cols-3 xl:grid-cols-4 gap-30">
      <div className="flex flex-col  gap-10 w-fit   col-span-3 xl:col-span-2">
        ...
        <div className="xl:col-span-2 col-span-3  py-5 relative flex flex-col items-center ">
